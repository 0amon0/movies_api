    ...
    return (
      <div>
        ...
        <React.Fragment>          
            ...
            <Link to='/register' style={{ textDecoration:'none',cursor: "pointer",outline:"none",padding: "7px",fontWeight:"bold",marginRight:"40px", border: "none" , color: "green", borderRadius:"15px", background:"yellow"}}>Sign Up</Link>
            </header>
        </React.Fragment>
      </div>
    )
